...
```{r}
plot <- ggplot(epsilonVariance, aes(x = Epsilon, y = performance, group = b1Variance, color = as.character(b1Variance), shape = as.character(b1Variance), min = performance - confidenceInterval, ymax = performance + confidenceInterval)) 
