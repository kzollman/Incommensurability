...
Performance, as measured subjectively
```{r}
plot <- ggplot(nonDomPopDivision, aes(x = PreferenceBias, y = subPerf, group = ResultCorrelation, color = as.character(ResultCorrelation), shape = as.character(ResultCorrelation)))
...
plot <- ggplot(nonDomPopDivision, aes(x = PreferenceBias, y = objPerf1, group = ResultCorrelation, color = as.character(ResultCorrelation), shape = as.character(ResultCorrelation))) 
