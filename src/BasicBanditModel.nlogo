...
@#$#@#$#@
<experiments>
  <experiment name="IndividualEpsilonSearch" repetitions="30000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
  ...
  <experiment name="NetworkSearch-e0" repetitions="10000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <steppedValueSet variable="Number-Of-Agents" first="2" step="1" last="20"/>
  ...
  <experiment name="Long-LengthSearch" repetitions="30000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <enumeratedValueSet variable="Number-Of-Agents">
  ...
  <experiment name="VarianceSearch" repetitions="30000" sequentialRunOrder="false" runMetricsEveryStep="false">
...
setup</setup>
  ...
  <experiment name="LengthSearch" repetitions="30000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <enumeratedValueSet variable="Number-Of-Agents">
  ...
  <experiment name="NetworkAndEpsilon" repetitions="20000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <enumeratedValueSet variable="Number-Of-Agents">
  ...
  <experiment name="InitialSample" repetitions="30000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <enumeratedValueSet variable="Number-Of-Agents">
  ...
  <experiment name="LengthSearch-e0" repetitions="30000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <enumeratedValueSet variable="Number-Of-Agents">
  ...
  <experiment name="BigGroup-NetworkSearch-e0" repetitions="10000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <enumeratedValueSet variable="Number-Of-Agents">
  ...
  <experiment name="InitialSample-Individual" repetitions="30000" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <metric>mean [my-performance] of turtles</metric>
    <enumeratedValueSet variable="Number-Of-Agents">
